...
function Home() {
    ...
    return (
        <Section>
            <div className="my-home min-h-[750px] lg:min-h-[calc(100vh-73px)] h-[calc(100svh-73px)] lg:h-[calc(100vh-73px)] lg:height-auto pl-5 pr-5 lg:pl-20 lg:pr-20 gap-10 lg:gap-35 flex-col-reverse lg:flex-row mt-[70px]">
