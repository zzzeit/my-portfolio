...
function FileTree({ selectedRepo, selectedFile, setSelectedFile }) {
    ...
    const fetchRepoContents = useCallback(async (path) => {
        ...
        try {
            if (!token) {
                console.warn("GitHub token is not set, falling back to unauthenticated requests for repository contents. Please add it to your .env file.");
            }
    ...
    return (
        <div className="relative">
            ...
            <div className="h-full w-full min-w-[250px] max-w-[250px] min-h-[200px] max-h-[200px] file-tree-container min-[825px]:max-h-full">
