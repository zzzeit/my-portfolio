...
function Repositories() {
    ...
    return (
        <Section id="repositories">
            <div className="my-repositories h-[1200px] lg:h-[calc(100vh-73px)] w-full pl-5 pr-5 pt-4 pb-4 lg:pl-20 lg:pr-20">
                <div className="bordered-container h-full  w-full">
                    ...
                    <div className="flex max-[700px]:flex-col min-[700px]:justify-center min-[700px]:max-h-[500px] w-full lg:flex-row gap-10">

                        <div className="repositories-list-container w-full lg:max-w-[300px]">
                            <div className="search-container relative mb-5 w-full lg:mb-0">
                            ...
                            <div className="grid-card flex flex-col h-[300px] min-[700px]:h-[calc(100%-62px)] w-full lg:flex-col gap-4 overflow-y-scroll scrollbar-none">
